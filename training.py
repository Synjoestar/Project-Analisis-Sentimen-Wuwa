...
Original file is located at
    https://colab.research.google.com/drive/1KvVqoJ6SMrL_v7TpyGUrnsltW-tqfdGm
"""
...
!pip install --no-cache-dir numpy==1.23.5 scipy==1.10.1 gensim==4.3.0
...
df = pd.read_csv('/content/ulasan.csv')
...
# explode harus memiliki jumlah nilai yang sama dengan sizes
explode = (0.1, 0, 0)
...
# Anda dapat mengubah ascending=True menjadi ascending=False jika ingin mengurutkan dari yang terbesar
